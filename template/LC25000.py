...
class TrainModel(object):
    def __init__(self, is_test, particle, batch_size, weight_decay):
        if is_test:
            ...
            full_trainloader = data_loader.get_train_loader('../datasets/LC25000_data/train', batch_size=batch_size,
                                                            augment=True, shuffle=True, num_workers=4, pin_memory=True)
            testloader = data_loader.get_test_loader('../datasets/LC25000_data/val', batch_size=batch_size,
                                                     shuffle=False,
